...
import com.example.abhinav.myecho.adapters.MainScreenAdapter
import java.util.*
...
class MainScreenFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        songsTitle = view?.findViewById<TextView>(R.id.songTitleMainScreen)
    ...
    fun bottomBarSetup() {
        try {
            ...
            songsTitle?.setText(SongPlayingFragment.Statified.currentSongHelper?.songTitle)
